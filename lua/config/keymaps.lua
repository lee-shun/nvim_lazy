...
end, { expr = true, noremap = true, desc = "Next popup item or Tab" })

vim.keymap.set("i", "<S-Tab>", function()
    return vim.v.pumvisible == 1 and "<C-p>" or "<Tab>"
end, { expr = true, noremap = true, desc = "Previous popup item or Tab" })
...
-- ─────────────────────────────────────────────────────────────
vim.keymap.set("v", "<", "<gv", { noremap = true, silent = true, desc = "Decrease indent and reselect" })
vim.keymap.set("v", ">", ">gv", { noremap = true, silent = true, desc = "Increase indent and reselect" })

-- ─────────────────────────────────────────────────────────────
-- Add blank lines and move lines
-- ─────────────────────────────────────────────────────────────
wk.add({
    { "[<leader>", ":<c-u>put! =repeat(nr2char(10), v:count1)<cr>'[", desc = "Add empty line above" },
    { "[<space>",  ":<c-u>put! =repeat(nr2char(10), v:count1)<cr>'[", desc = "Add empty line above" },
    { "[e",        ":<c-u>execute 'move -1-'. v:count1<cr>",        desc = "Move line up" },
    { "]<leader>", ":<c-u>put =repeat(nr2char(10), v:count1)<cr>",   desc = "Add empty line below" },
    { "]<space>",  ":<c-u>put =repeat(nr2char(10), v:count1)<cr>",   desc = "Add empty line below" },
